...
const mapStateToProps = state => {
    return {
        ...
        preLayout: state.nav.preLayout,
        collapseMenu: state.nav.collapseMenu,
        layoutType: state.nav.layoutType,
        navBackColor: state.nav.navBackColor,
        navBackImage: state.nav.navBackImage,
        navIconColor: state.nav.navIconColor,
        navBrandColor: state.nav.navBrandColor,
        layout6Background: state.nav.layout6Background,
        layout6BackSize: state.nav.layout6BackSize,
        rtlLayout: state.nav.rtlLayout,
        navFixedLayout: state.nav.navFixedLayout,
        boxLayout: state.nav.boxLayout,
        navDropdownIcon: state.nav.navDropdownIcon,
        navListIcon: state.nav.navListIcon,
        navActiveListColor: state.nav.navActiveListColor,
        navListTitleColor: state.nav.navListTitleColor,
        navListTitleHide: state.nav.navListTitleHide
    }
};
