    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_type', models.CharField(choices=[('cashe', 'Cashe'), ('card', 'Bank Card')], default='cashe', max_length=10, verbose_name='Type of wallet')),
                ...
                ('initial_balance', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), max_digits=10, verbose_name='Initial balance')),
