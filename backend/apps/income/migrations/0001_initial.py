# Generated by Django 3.1.3 on 2020-11-18 23:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('wallet', '0005_auto_20201115_1210'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='EUR', max_digits=10, verbose_name='Amount')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incomes', to='income.incomecategory', verbose_name='Category')),
                ('to_wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incomes', to='wallet.wallet', verbose_name='To wallet')),
