    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actions', to='wallet.wallet', verbose_name='To wallet')),
            ],
            options={
                'verbose_name': 'Action',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='action.expensecategory', verbose_name='Category')),
            ],
            bases=('action.action',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('action_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='action.action')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incomes', to='action.incomecategory', verbose_name='Category')),
            ],
            bases=('action.action',),
        ),
    ]
