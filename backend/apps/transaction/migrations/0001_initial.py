# Generated by Django 3.1.5 on 2021-02-25 18:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, max_digits=10, verbose_name='Amount')),
                ('is_transfer', models.BooleanField(default=False, verbose_name='Is transfer?')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incomes', to='account.account', verbose_name='To account')),
            ],
            options={
                'verbose_name': 'Income',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='income_categories', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='income',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incomes', to='transaction.incomecategory', verbose_name='Category'),
        ),
        migrations.AddField(
            model_name='income',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='Category')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expense_categories', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, max_digits=10, verbose_name='Amount')),
                ('is_transfer', models.BooleanField(default=False, verbose_name='Is transfer?')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='account.account', verbose_name='To account')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='transaction.expensecategory', verbose_name='Category')),
